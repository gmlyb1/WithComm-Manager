			...
			<div class="panel-body">
				<form action="/board/create" method="post" name="write" id="write"
					...
					<div class="table-responsive" style="text-align: center;">
						<table id="datatable-scroller"
							...
							<tr>
								...
								<td class="form-inline">
									<textarea id="board_content" name="board_content" cols="100" rows="10" placeholder="내용을 입력해주세요." class="form-control"></textarea>
								</td>
							</tr>
							</tbody>
						</table>
					...
					<div style="margin-left: 1px;">
						...
						<a href="/board/list" class="btn btn-danger cancel">취소</a>
					</div>
				</form>
			</div>
		</div>
