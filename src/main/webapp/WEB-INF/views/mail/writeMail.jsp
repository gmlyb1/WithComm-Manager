            ...
            <div class="card-body">
            	<form action="./writeMail" method="post" enctype="multipart/form-data" onsubmit="return writeCk();">
	               	<div style="margin-bottom:5px;">
						...
						<button type="button" class="btn btn-success btn-xs mr-2" onclick="emp_select()">주소록</button>
					</div>	
					<div class="mb-3">
                	...
                	<div style="text-align:right;">
                		<input type="submit" class="btn btn-primary" value="보내기"/>
                		<button type="button" class="btn btn-danger" onclick="location.href='recMail'">취소</button>
                	</div>
				</form>
            </div>
         </div>
