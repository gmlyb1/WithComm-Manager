...
<form action="/item/itemInsert" method="post" name="itemInsertForm"
	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="itemInsert_1">
			...
			<div class="form-group">
				<h3>사이즈</h3>
				<input class="form-control input-lg" type="text" placeholder="사이즈"
					name="item_size" id="item_size" />
			</div>
			<hr class="divider-w mt-10 mb-20">
			<div class="form-group">
				<h3>색상</h3>
				<input class="form-control input-lg" type="text" placeholder="색상"
					name="item_color" id="item_color" />
			</div>
			<hr class="divider-w mt-10 mb-20">
			...
			<div class="form-group">
				<h3>모델정보</h3>
				<input class="form-control input-lg" type="text" placeholder="모델정보"
					name="item_model" id="item_model" />
			</div>
			<hr class="divider-w mt-10 mb-20">
			...
			<div class="tab-pane" id="itemInsert_3">
				...
				<button class="btn btn-success" type="button"
					onclick="fnSubmit(); return false;">상품 등록</button>
				<a href="/item/manage" class="btn btn-danger">메인 페이지로 이동</a>
