    ...
    <div class="outer">
        <div class="middle">
            <div class="inner">
                ...
                <span class="inner-status" style="color='red'">페이지 접근 불가</span>
                <span class="inner-detail">
                    <strong>접근 불가능합니다. <br>관리자에게 문의해주세요.</strong> <br>
                    <a href="/account/login" class="btn btn-info mtl"> 
                    <i class="fa fa-home"></i>&nbsp; 로그인 페이지로
                    </a> 
                </span>
            </div>
        </div>
