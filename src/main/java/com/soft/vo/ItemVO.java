...
public class ItemVO {
	...
	public String toString() {
		return "ItemVO [item_no=" + item_no + ", item_admin=" + item_admin + ", item_name=" + item_name
				...
				+ ", item_star=" + item_star + ", item_catemain=" + item_catemain + ", item_catesub=" + item_catesub
				+ ", item_subcontent=" + item_subcontent + ", item_model=" + item_model + ", item_imgmain="
				+ item_imgmain + ", item_option=" + Arrays.toString(item_option) + ", item_vol="
				+ Arrays.toString(item_vol) + ", option_content=" + option_content + ", option_item_no="
